...
"""
  ...
  def test_custom_call_coverage(self):
    ...
    covering_testdatas = [
        ...
        tpu_stablehlo_dynamic_reduce_window.data_2023_06_16]
  ...
  def test_tpu_stablehlo_dynamic_reduce_window(self):
    ...
    data = load_testdata(tpu_stablehlo_dynamic_reduce_window.data_2023_06_16)
    self.run_one_test(
        func, data,
